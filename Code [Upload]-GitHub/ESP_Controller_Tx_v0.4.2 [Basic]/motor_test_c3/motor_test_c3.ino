 ...
 *  GPIO 8  → STBY   TB6612 enable  ← OR hardwire STBY to 3V3
 *  3V3     → VCC    TB6612 logic supply
 *  GND     → GND    common ground
 *  LiPo+   → VM     motor power rail
 *
 *  NOTE: If GPIO 8 won't drive STBY HIGH (current sink issue),
 *  just wire STBY directly to 3V3 and remove STBY code below.
 * ============================================================
 */
...
#define DRIVE_SPEED   180   // straight forward/backward speed
