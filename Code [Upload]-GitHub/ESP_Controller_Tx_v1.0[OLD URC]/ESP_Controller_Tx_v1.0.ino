...
#define SW1_PIN      18   // Toggle switch 1       (SW1) ← NEW
#define SW2_PIN      19   // Toggle switch 2       (SW2) ← NEW
...
#define POTM2_PIN  39    // Potentiometer 2  (PotM2) ← NEW
...
void DataWork() {
  ...
  data.PotM2 = mapPot(analogRead(POTM2_PIN));
...
void setup() {
  ...
  lcd.setCursor(0, 2); lcd.print("    ESP-NOW v0.4    ");
  lcd.setCursor(0, 3); lcd.print("====================");
  delay(350);
