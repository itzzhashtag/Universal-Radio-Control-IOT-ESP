//================================================================
// URC v0.9 - MAC 20:e7:c8:9f:47:f8
// ================================================================
// ESP-NOW RC Controller  v0.9
...
void DataWork() {
  ...
  Serial.printf("L(%3d,%3d) R(%3d,%3d) | LS:%d RS:%d | LB:%d RB:%d  | SW1:%d SW2:%d | P1:%d | BAT:%.2fV %3d%% | Status:%s\n",
                data.Lx, data.Ly, data.Rx, data.Ry, data.LABt, data.RABt, data.LBt, data.RBt, data.TSW1, data.TSW2, data.Pot1, batteryVoltage, data.BAT, (Stat ? "Connected" : "Dead"));
}
...
void setup() {
  ...
  lcd.print("====================");
  lcd.setCursor(0, 1);
  lcd.print("  Radio Booting...  ");
  lcd.setCursor(0, 2);
  lcd.print("    ESP-NOW v0.9    ");
  lcd.setCursor(0, 3);
  lcd.print("====================");
